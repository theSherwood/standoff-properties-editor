      ...
      for (var i = 0; i < props.length; i++) {
        ...
        if (_.monitorOptions.highlightProperties) {
          type.addEventListener("mouseover", function (e) {
            setTimeout(() => {
              var span = getParent(e.target, function (x) {
                return !!x.property;
              });
              if (!span) {
                return;
        ...
        if (!!prop.value) {
          ...
          link.addEventListener("click", function (e) {
            ...
            var p = span.property;
            _.propertyType[p.type].propertyValueSelector(p, function (
              guid,
              name
            ) {
              if (guid) {
        ...
        if (prop.isZeroPoint) {
          if (propertyType.zeroPoint) {
            if (propertyType.zeroPoint.selector) {
              var zeroPointLabel = this.newSpan(
                this.monitorButton.zeroPointLabel || "[label]"
              );
        ...
        var showConvertToZeroPoint =
          propertyType.zeroPoint &&
          propertyType.zeroPoint.offerConversion &&
          propertyType.zeroPoint.offerConversion(prop);
        if (showConvertToZeroPoint) {
          var toZeroPoint = this.newSpan(
            this.monitorButton.toZeroPoint || "[Z]"
          );
        ...
        if (hasProperties(propertyType.attributes)) {
          ...
          for (var key in propertyType.attributes) {
            ...
            attr.addEventListener("click", function (e) {
              var span = getParent(e.target, function (x) {
                return !!x.speedy && !!x.speedy.property;
              });
              if (!span) {
                return;
              }
              ...
              _.propertyType[p.type].attributes[name].selector(p, function (
                value
              ) {
        ...
        openArrow.innerHTML =
          "<span data-toggle='tooltip' data-original-title='Open' class='fa fa-chevron-circle-right monitor-arrow-icon'></span>";
        ...
        closeArrow.innerHTML =
          "<span data-toggle='tooltip' data-original-title='Close' class='fa fa-chevron-circle-left monitor-arrow-icon'></span>";
